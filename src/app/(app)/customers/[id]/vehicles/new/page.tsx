...
export default function NewVehiclePage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast({
      title: "Vehicle Added",
      description: `${values.nickname} has been added to ${customer?.name}.`,
    });
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <PageHeader
          ...
          description={`Register a new vehicle for ${customer?.name}.`}
        >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter the details for the new vehicle below.</CardDescription>
          </CardHeader>
